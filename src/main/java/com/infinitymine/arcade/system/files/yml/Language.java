...
import com.infinitymine.arcade.system.util.Messages;
...
public enum Language {
    ...
    VANISH_EN("messages.vanish.vanish-enabled", "{prefix} &3Vanish enabled!"),

    VANISH_DIS("messages.vanish.vanish-disabled", "{prefix} &3Vanish disabled!"),

    VANISH_EN_OTHER("messages.vanish.vanish-enabled-other", "{prefix} &3Vanish enabled for &b{target}"),

    VANISH_DIS_OTHER("messages.vanish.vanish-disabled-other", "{prefix} &3Vanish disabled for &b{target}")
    ...
    public static void saveFile() {
        InfinityArcade.getResourceProvider().saveResource(Language.getLocale());
    }
