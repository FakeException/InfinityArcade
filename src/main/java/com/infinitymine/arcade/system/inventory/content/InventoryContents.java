package com.infinitymine.arcade.system.inventory.content;

import com.infinitymine.arcade.system.inventory.ClickableItem;
import com.infinitymine.arcade.system.inventory.OmegaInventory;
...
public interface InventoryContents {
    ...
    class Impl implements InventoryContents {
        ...
        public Impl(OmegaInventory inv, Player player) {
            this.inv = inv;
            this.player = player;
        ...
        @Override
        public OmegaInventory inventory() { return inv; }
