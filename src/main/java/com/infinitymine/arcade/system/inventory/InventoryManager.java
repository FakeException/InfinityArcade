package com.infinitymine.arcade.system.inventory;

import com.infinitymine.arcade.system.inventory.content.InventoryContents;
import com.infinitymine.arcade.system.inventory.opener.ChestInventoryOpener;
import com.infinitymine.arcade.system.inventory.opener.InventoryOpener;
import com.infinitymine.arcade.system.inventory.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<Player, OmegaInventory> inventories;
    ...
    public List<Player> getOpenedPlayers(OmegaInventory inv) {
    ...
    public Optional<OmegaInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p));
    }

    protected void setInventory(Player p, OmegaInventory inv) {
        if(inv == null)
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if(e.getClickedInventory() == p.getOpenInventory().getTopInventory()) {
                ...
                OmegaInventory inv = inventories.get(p);
