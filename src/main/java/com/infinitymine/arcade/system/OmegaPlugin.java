package com.infinitymine.arcade.system;

import com.google.common.collect.Lists;
import com.infinitymine.arcade.system.inventory.InventoryManager;
import com.infinitymine.arcade.system.register.Registrable;
import com.infinitymine.arcade.system.resource.DefaultResourceProvider;
import com.infinitymine.arcade.system.resource.ResourceProvider;
import com.infinitymine.arcade.system.resource.json.JsonResourceHandler;
import com.infinitymine.arcade.system.resource.yml.YamlResourceHandler;
import com.infinitymine.arcade.system.util.logging.ConsoleLog;
import com.infinitymine.arcade.system.util.logging.StaticLog;
import com.infinitymine.arcade.system.util.reflect.Reflection;
...
/**
 * The {@link OmegaPlugin} is responsible for loading and enabling components
 * within the library.
 *
 * @author zBackDo_or_
 */
public class OmegaPlugin extends JavaPlugin {
    ...
    public final void onLoad() {
        ...
        console.setFormat("[&3" + (description.getPrefix() != null ? description.getPrefix() : description.getName()) + "&r] [{InfinityArcade_log_level}]: {InfinityArcade_log_message}");
    ...
    public void setResourceProvider(ResourceProvider resourceProvider) {
        OmegaPlugin.resourceProvider = resourceProvider;
    }
