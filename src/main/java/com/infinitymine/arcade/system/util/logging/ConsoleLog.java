package com.infinitymine.arcade.system.util.logging;
...
public class ConsoleLog {
    ...
    private String logFormat = "[&3Omega&bCore&r] [{InfinityArcade_log_level}]: {InfinityArcade_log_message}";
    ...
    public void log(ConsoleLevel level, String message, Object... args) {
        log(Messages.colour(logFormat
                .replace("{InfinityArcade_log_level}", level.getTagColour() + level.getTag() + ChatColor.RESET)
                .replace("{InfinityArcade_log_message}", message)), args);
    }
